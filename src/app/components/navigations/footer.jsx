        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
              ...
              <h3 className="font-bold text-2xl mb-2">Alamat Kami</h3>
              {/* <p>abdurrohmanhaadziq@gmail.com</p> */}
              <p>Jl. village Cetan, Ceper, Klaten Regency</p>
              <p> Central Java 57465</p>
            </div>
          ...
          <div className="w-full pt-10 border-t border-slate-700">
            ...
            <p className="font-medium text-xs text-slate-500 text-center mr-6">
              &#169;{" "}
